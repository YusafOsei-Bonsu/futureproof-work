...
describe('API Routes', function() {
  ...
  describe('PUT /api/v1/shows/:id', function() {
    ...
    it('should NOT update a show if the id field is part of the request', function(done) {
      ...
      .end(function(err, res) {
        // by adding the if statement here you are changing the functionality that is being tested
        // this essentially will give you a false positive - change is required in update/PUT in index.js
